...
Router::add('/ranks', 'ranks.kills()');
Router::add('/ranks/kills', 'ranks.kills()');
Router::add('/ranks/deaths', 'ranks.deaths()');
Router::add('/ranks/core', 'ranks.core()');
Router::add('/ranks/monument', 'ranks.monument()');
...
//Router::add('/logout', 'index.logout()');
