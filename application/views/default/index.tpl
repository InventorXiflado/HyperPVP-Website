  ...
  <body>
    ...
    <div class="container">
      ...
      <hr>
		...
		<?php if (Session::isAuthed() && count(FriendDao::friendRequests(Session::auth()->username)) != 0) { ?>

		<div class="alert alert-info" style="text-decoration: none">
		<strong>You have friend requests!</strong>
		You have a total of <strong><?php echo count(FriendDao::friendRequests(Session::auth()->username)); ?></strong> friend requests. View your friend requests <a href="{$site->url}/friend/requests"><button class="btn btn-primary btn-mini" type="button">click here</button></a>
		</div>
